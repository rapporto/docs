...
Only text push-messages can be sent via the HTTP API.

| Lifetime of push-messages: from 30 to 86400 seconds (24 hours).
...
.. _engHTTP-Push-параметры-запроса:
...
|                    |         |              |         <summary>More details</summary>                                                                              |
|                    |         |              |         <p>                                                                                                          |
|                    |         |              |             Specified in the <code>hh_hh</code> format, where two hour values specify the time period in which the   |
...
|                    |         |              |     <div class="admonition note">                                                                                    |
|                    |         |              |         <p class="admonition-title">Note</p>                                                                         |
|                    |         |              |         <p>For example, if the parameter value is <code>sending_time = 10_20</code>, the message will be sent within |
|                    |         |              |            the period from 10:00 to 20:00 local time in the time zone of the subscriber.                             |
|                    |         |              |            </p>                                                                                                      |
|                    |         |              |     </div>                                                                                                           |
|                    |         |              |         <p>                                                                                                          |
...
|                    |         |              |             according to local time of this time zone, otherwise the time zone of the subscriber will be             |
|                    |         |              |             determined by the subscriber's phone number.                                                             |
|                    |         |              |         </p>                                                                                                         |
|                    |         |              |     <div class="admonition note">                                                                                    |
|                    |         |              |         <p class="admonition-title">Note</p>                                                                         |
...
|                    |         |              |         </p>                                                                                                         |
|                    |         |              |         <p>                                                                                                          |
|                    |         |              |             This parameter is optional. If the parameter is missing in the request, the message will be sent to the  |
|                    |         |              |             subscriber from the default service name (setting on the Service Provider's side).                       |
|                    |         |              |         </p>                                                                                                         |
...
|                    |         |              |             see <a href="https://doc.rapporto.ru/api/eng/http_eng/eng_http_push.html#response-in-the-xml-format">    |
|                    |         |              |             Response in the XML Format</a>.                                                                          |
|                    |         |              |         </p>                                                                                                         |
|                    |         |              |         <p>                                                                                                          |
|                    |         |              |             If the parameter is not defined or is different, the default format is used: text/plain                  |
|                    |         |              |             (see <a href="https://doc.rapporto.ru/api/eng/http_eng/eng_http_push.html#response">                     |
...
|                    |         |              |     <div class="admonition important">                                                                               |
|                    |         |              |         <p class="admonition-title">Important</p>                                                                    |
|                    |         |              |         <p>This option is not available by default. The activation of this functionality should be agreed with your  |
...
.. tabs::
    ...
    .. tab:: Description of XML elements
        ...
        |                 |         | for responses of type text/plain).               | :ref:`above. <pКод-ош-при-отпр-запроса>` |
        +-----------------+---------+--------------------------------------------------+------------------------------------------+
        | text            | no      | Additional brief textual information about       | It may contain an error information.     |
        |                 |         | the response.                                    |                                          |
        +-----------------+---------+--------------------------------------------------+------------------------------------------+
        | payload         | no      | Information about the message, contains the      | Transmitted only in case of a            |
