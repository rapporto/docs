...
.. tabs::
    ...
    .. tab:: Параметры GET-запроса
      ...
      |                    |         |              |     </details>                                                                                     |
      +--------------------+---------+--------------+----------------------------------------------------------------------------------------------------+
      | status             | да      | integer      | Статус доставки сообщения. Возможные значения:                                                     |
      |                    |         |              |                                                                                                    |
      |                    |         |              | .. raw:: html                                                                                      |
      |                    |         |              |                                                                                                    |
      |                    |         |              |     <details>                                                                                      |
...
.. tabs::
      ...
      .. tab:: SMS
            ...
            +----------------------------+--------------------------------------------------------------------------------+
            | 16                         | В момент доставки SMS-сообщения телефон был занят приёмом или передачей        |
            |                            | другого короткого сообщения.                                                   |
            +----------------------------+--------------------------------------------------------------------------------+
            | 18                         | Во время отправки сообщения один или несколько параметров SMS-сообщения были   |
      ...
      .. tab:: PUSH
            ...
            |                            | на основное утройство (primaryOn = true).                                      |
            +----------------------------+--------------------------------------------------------------------------------+
