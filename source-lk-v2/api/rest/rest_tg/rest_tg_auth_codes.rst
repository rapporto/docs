...
.. raw:: html
     ...
     <details>
         ...
         <p>
             Сервис Telegram Gateway предназначен для доставки пользователям мессенджера Telegram авторизационных и верификационных цифровых кодов. Для отправки кода необходимо передать запрос, содержащий соответствующий код. Указанный код (без сопутствующего текста) будет передан оператору, который вставит его в текст шаблона сообщения.
         </p>
         <p>
