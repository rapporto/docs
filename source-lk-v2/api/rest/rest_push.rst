...
Параметры для отправки веб push-уведомлений отмечены *.
...
+----------------------------------+------------------+--------------------------------------------------------------------------------+
| notifyUrl *                      | string           | | Имя хоста входящего API для получения отчета о доставке (см.                 |
|                                  |                  |   :doc:`rest_status`).                                                         |
...
|                                  |                  |   Push-сообщение передаваемая ссылка откроется в webView. Не поддерживается в  |
|                                  |                  |   веб push-сообщениях.                                                         |
+----------------------------------+------------------+--------------------------------------------------------------------------------+
...
|                                  |                  |   для мобильного и веб приложения;                                             |
...
|                                  |                  |   типы платформ (APNS, FCM, HMS, RuStore, Pwa).                                |
+----------------------------------+------------------+--------------------------------------------------------------------------------+
