...
Загружайте список контактов, объединяйте их в сегменты и используйте эти сегменты в любой рассылке. Номера, которые нужно исключить из рассылки, добавляйте в черный список.
