...
7. В блоке **"Производить расчет по средней цене для"** отметить, для каких операторов необходимо выполнить расчет по средней цене. Редактирование данных настроек доступно только при выборе сводного типа разбивки в блоке **"Тип разбивки"**.
