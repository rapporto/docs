...
3. В форме настроек выбрать команду, по которой необходимо построить отчет.
...
5. В блоке **“Тип разбивки”** выбрать необходимый вариант разбивки отчета. Возможные значения:
...
6. При необходимости выбрать дополнительные опции: включать в отчет абонентскую плату или комиссии и скидки. Возможно использовать оба параметра.

7. В блоке **“Производить расчет по средней цене для”** отметить, для каких операторов необходимо выполнить расчет по средней цене.
