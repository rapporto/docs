...
.. note:: После добавления контактов и ввода текста сообщения под формой предпросмотра текста будет отображена предварительная стоимость рассылки. Итоговая стоимость SMS-сообщения зависит от количества частей в рассылке. Предварительная стоимость отображается только при загрузке контактов из файла или при ручном вводе.
