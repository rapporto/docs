...
7. В открывшейся форме:
   ...
   * в поле **"Текст сообщения"** ввести текст сообщения. Счетчик под формой ввода текста отображает количество оставшихся и введенных символов в одной части SMS-сообщения, а также количество частей. Пример сообщения будет отображен в форме предпросмотра текста, расположенной справа.
     ...
     Чекбокс **"Сохранить как переиспользуемый черновик"** позволяет сохранить текущий текст сообщения как черновик для последующего использования. Данная опция незаменима для сообщений, содержащих `параметры подстановки <https://doc.rapporto.ru/lk/substitutions.html>`_, поскольку стандартный механизм черновиков их не сохраняет.
