...
5. В блоке **“Настройки таблицы”** установить необходимые параметры отображения отчета:
   ...
   * выбрать колонки отчета. По умолчанию выбрано 8 колонок — команда, дата и время, вид трафика, получатель, наименование сервисного имени, статус, тип сообщения, тип трафика. По мере добавления или удаления колонок пример отображения отчета будет меняться.
