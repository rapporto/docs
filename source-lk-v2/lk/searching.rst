...
.. image:: media/searching_messages.gif
...
* Тип сообщения — SMS, Viber, Telegram, Push;

* Направление — наименование оператора;
...
При необходимости можно скачать результаты поиска.
