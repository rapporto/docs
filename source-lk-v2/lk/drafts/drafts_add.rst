...
.. note:: 
   ...
   Чтобы добавить в черновики текст сообщения с `параметрами подстановки <https://doc.rapporto.ru/lk/substitutions.html>`_, необходимо включить опцию **"Сохранить как переиспользуемый черновик"** при `создании SMS-рассылки <https://doc.rapporto.ru/lk/sms_sender.html>`_.  
