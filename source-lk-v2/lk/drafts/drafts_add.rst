...
5. В поле **"Текст сообщения"** ввести текст сообщения. Максимальная длина — 2000 символов. Чтобы добавить текст с `параметрами подстановки <https://doc.rapporto.ru/lk/substitutions.html>`_, необходимо использовать квадратные скобки "[" и "]".
   
   Счетчик под формой ввода текста отображает количество оставшихся и введенных символов в одной части сообщения, а также количество частей. На панели инструментов доступны кнопки для автоматического форматирования текста:
