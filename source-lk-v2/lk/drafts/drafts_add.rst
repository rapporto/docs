...
5. В поле **"Текст сообщения"** ввести текст сообщения. Чтобы добавить текст с `параметрами подстановки <https://doc.rapporto.ru/lk/substitutions.html>`_, необходимо использовать квадратные скобки "[" и "]".
