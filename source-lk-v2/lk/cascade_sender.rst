...
.. note:: На примере выше представлен сценарий: если спустя 10 минут после отправки SMS-сообщения не вернулся статус "Доставлено", — будет отправлено Viber-сообщение.
