...
В личном кабинете реализована возможность отправки отложенной рассылки, которая будет выполнена в соответствии с указанными датой и временем старта. 

.. image:: media/delayed_sender1.gif

Для настройки параметров отложенной отправки рассылки необходимо выполнить следующее:
