...
5. В открывшейся форме:
   ...
   * в поле **"Текст сообщения"** указать текст сообщения с параметрами подстановки. 
    
     Для вставки данных параметров необходимо в панели инструментов нажать на кнопку **<Добавить подстановку>** и выбрать нужный параметр или ввести в тексте сообщения символ "[" и выбрать требуемый параметр из выпадающего списка.    
     
     Для вставки ранее сохраненного в черновиках текста сообщения с параметрами подстановки необходимо нажать на кнопку **<Добавить черновик>** и выбрать соответствующий черновик из выпадающего списка.  
     

   .. important:: 
   
      Наименования параметров подстановки в квадратных скобках должны соответствовать наименованиям столбцов в загруженном файле с переменными данными. 
 
     
   При этом в форме предпросмотра, расположенной справа, будет отображен пример сообщения с подстановками.
