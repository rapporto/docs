...
.. note:: После добавления контактов и ввода текста сообщения под формой предпросмотра текста будет отображена предварительная стоимость рассылки. Она выводится только при загрузке контактов из файла или при ручном вводе.
