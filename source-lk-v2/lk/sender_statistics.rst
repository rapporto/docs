...
Во вклдаке **“Повторная отправка”** отображается информация по параметрам повторной отправки рассылки в случае, если она была настроена при создании рассылки. 
