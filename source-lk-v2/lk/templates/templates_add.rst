...
Успешно зарегистрированные оператором шаблоны отобразятся на вкладке **"Список шаблонов"** со статусом **"Новый"**. Информацию об отклоненных шаблонах появится на вкладке **"История загрузок"** (подробнее в статье :doc:`templates_history`).
