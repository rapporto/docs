...
3. В форме регистрации шаблона на первом этапе **"Подготовка"** выполнить следующие шаги:
   ...
   * Допустимые кодировки файла: Windows-1251 или UTF-8.   
...
6. На третьем этапе **"Результаты"** приводятся списки отправленных на регистрацию шаблонов и шаблонов с ошибками. Для того чтобы скачать шаблоны с ошибками, необходимо перейти на соответствующую вкладку и нажать на кнопку **<Скачать все шаблоны с ошибкой>**.

Успешно зарегистрированные оператором шаблоны отобразятся на вкладке **"Список шаблонов"** со статусом **"Новый"**. Информация об отклоненных шаблонах появится на вкладке **"История загрузок"** (подробнее в статье :doc:`templates_history`).
