...
Разработан функционал для отправки веб push-сообщений на устройства пользователей. Более подробно — в статьях :doc:`push_service/rpns` и :doc:`push_service/sdk/web_sdk`.
