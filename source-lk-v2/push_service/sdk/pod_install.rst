...
Дальнейшие шаги по интеграции библиотеки в части создания и настройка расширений, а также настройки App Group идентичны описанным в статье :doc:`manually_install`, начиная с раздела :ref:`creating_app_extensions`.
