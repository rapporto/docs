...
| Для реализации отправки push-сообщений на мобильное и веб приложение мы предлагаем свой комплект для разработки программного обеспечения — мобильный и веб :abbr:`SDK (Software Development Kit)`. 
