...
В раздел "Интеграции" добавлена страница :doc:`introduction`, которая содержит сводные таблицы с поддерживаемыми типами сообщений. Страница может помочь Партнеру при выборе интеграции.


Июль
~~~~~~

В REST API добавлен тип ``MAX`` для передачи абонентам :doc:`сообщений <rest_max>` в мессенджер MAX, в том числе, в каскадной рассылке.
