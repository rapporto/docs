...
| Для реализации отправки push-сообщений на мобильное приложение мы предлагаем свой комплект для разработки программного обеспечения Software Development Kit (SDK). 
