...
To send a message to a subscriber, the Partner makes a request to a specific URL of the Service Provider using an HTTP GET or POST method, 
in which they provide the subscriber's number, the message text, and other parameters.
