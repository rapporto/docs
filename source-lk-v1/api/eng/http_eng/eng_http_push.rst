...
|                           |                         |                                                                                  |
|                           |                         | | For the zero time zone it is required to specify a sign "+" or "-".            |
...
|                           |                         | (see :ref:`Response in XML format <Ph engОтвет в формате XML>`).                 |
|                           |                         |                                                                                  |
|                           |                         | If the parameter is not defined or is different, the default format is used:     |
|                           |                         | :abbr:`text/plain (Simple text)`                                                 |
|                           |                         | (see :ref:`Response to the request <Ph engОтвет на запрос>`).                    |
+---------------------------+-------------------------+----------------------------------------------------------------------------------+
