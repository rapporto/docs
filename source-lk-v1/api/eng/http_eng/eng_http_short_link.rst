...
| This service is connected by the Service Provider upon request from the Partner (see :ref:`engHTTP-Подключение-ССС`).
...
.. _engHTTP-Подключение-ССС:

Service setup
--------------------

To connect the Service, the following data must be transmitted to :ref:`Technical Support <support>`:
