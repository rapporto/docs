...
The service supports the following types of Viber messages:
...
| The Viber message lifetime is is passed in the request in the *viberTtl* parameter.
...
+---------------------------+-------------------------+----------------------------------------------------------------------------------+
| buttonLink                | string                  | | The link to go to after clicking on the button.                                |
