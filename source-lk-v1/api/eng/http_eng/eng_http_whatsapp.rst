...
|                    |         |              |             see <a href="https://doc.rapporto.ru/api/eng/http_eng/eng_http_whatsapp.html#response-in-the-xml-format">|
|                    |         |              |             Response in the XML Format</a>.                                                                          |
|                    |         |              |         </p>                                                                                                         |
|                    |         |              |         <p>                                                                                                          |
|                    |         |              |             If the parameter is not defined or is different, the default format is used: text/plain                  |
|                    |         |              |             (see <a href="https://doc.rapporto.ru/api/eng/http_eng/eng_http_whatsapp.html#response">                 |
...
.. _Коды-ошб-при-отпр-запроса-eng:
...
.. _WA engОтвет в формате XML:

Response in the XML Format
~~~~~~~~~~~~~~~~~~~~~~~~~~~~

| To receive the response in :abbr:`XML (Xtensible Markup Language)` format the Partner needs to send the ``output =x ml`` parameter in the body of the request.
...
.. tabs::
    ...
    .. tab:: Description of XML elements
        ...
        |                 |         | for responses of type text/plain).               | :ref:`above. <Коды-ошб-при-отпр-запроса-eng>` |
        +-----------------+---------+--------------------------------------------------+-----------------------------------------------+
