...
Only text messages can be sent via the HTTP API into WhatsApp.
...
|                           |                         | (see :ref:`Response in XML format <WA engОтвет в формате XML>`).                 |
|                           |                         |                                                                                  |
|                           |                         | If the parameter is not defined or is different, the default format is used:     |
|                           |                         | :abbr:`text/plain (Simple text)`                                                 |
|                           |                         | (see :ref:`Response to the request <WA engОтвет на запрос>`).                    |
+---------------------------+-------------------------+----------------------------------------------------------------------------------+
...
|                           |                         |     manager.                                                                     |
|                           |                         |                                                                                  |
|                           |                         | For more details see: `Сервис сокращения ссылок для                              |
