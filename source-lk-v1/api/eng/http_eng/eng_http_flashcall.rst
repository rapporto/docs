...
* the text should necessarily contain a 4-digit or 6-digit digital code used to call the subscriber (otherwise the request is returned with an error *400, Invalid request, Flashing Call text should contain a 4(6)-digit code*);
...
Sending request for FlashingCall (Voice Code) messages
-------------------------------------------------------
