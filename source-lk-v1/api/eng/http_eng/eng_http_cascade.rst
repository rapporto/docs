...
Cascade sending of messages is not available by default. To connect it the Partner needs to contact his supervising manager.

The service supports the following types of Cascade sending:
...
+--------------------+--------------+----------------------------------------------------------------------------------------------------+
| Name of the        | Type         | Description of the parameter                                                                       |
| parameter          |              |                                                                                                    |
+====================+==============+====================================================================================================+
| order_list         | string       | | A list specified the send sequence.                                                              |
|                    |              | | The types of messages should be listed in the order in which they should be sent.                |
