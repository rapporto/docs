...
|                           |                          |         <summary>More details</summary>                                                                    |
|                           |                          |         <p>                                                                                                |
|                           |                          |             The request for transmitting an authorization code (including the main channel in the cascading|                                                   
|                           |                          |             message sending) must contain the service name, which is separately agreed upon with the       |
