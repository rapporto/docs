...
|                                |        |              |         <summary>Подробнее</summary>                                             |
|                                |        |              |         <p>                                                                      |
|                                |        |              |             Если не указано, сообщение отправляется сразу же,                    |
...
|                                |        |              |         </p>                                                                     |
|                                |        |              |         <p>                                                                      |
|                                |        |              |             Пример: <code>2019-05-10T16:29:30+0300</code>.                       |
|                                |        |              |         </p>                                                                     |
|                                |        |              |     </details>                                                                   |
+--------------------------------+--------+--------------+----------------------------------------------------------------------------------+
...
|                                |        |              |            лимит значения у параметра link».                                     |
|                                |        |              |         </p>                                                                     |
|                                |        |              |         <p>                                                                      |
|                                |        |              |             Если передан пустой параметр, сообщение будет отклонено с ошибкой.   |
|                                |        |              |             Текст ошибки: «В сообщении отсутствует значение у параметра link».   |
|                                |        |              |         </p>                                                                     |
|                                |        |              |     </details>                                                                   |
+--------------------------------+--------+--------------+----------------------------------------------------------------------------------+
...
|                                |        |              |     </details>                                                                   |
+--------------------------------+--------+--------------+----------------------------------------------------------------------------------+
| message/data/ttl               | нет    | integer      | Время жизни сообщения с момента отправки (независимо от того, отправилось        |
|                                |        |              | оно сразу или по расписанию, указанному в блоке параметров ``scheduleInfo``).    |
|                                |        |              |                                                                                  |
|                                |        |              | .. raw:: html                                                                    |
|                                |        |              |                                                                                  |
|                                |        |              |     <details>                                                                    |
...
.. tabs::
    ...
    .. tab:: Описание параметров 
         ...
         В уведомлении о событии все параметры **обязательные**.
