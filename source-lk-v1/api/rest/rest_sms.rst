...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |                                                   
|                       |         |              |             Если <code>false</code>, то сообщение отправляется согласно расписанию инициатора   |
|                       |         |              |             рассылки UTC+3, не обращая внимание на часовой пояс получателя сообщения.           |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
...
|                       |         |              |             (сервис контроля включается отдельно). Партнёр может вызывать Сервис-провайдера     |
|                       |         |              |             (запрос на отправку сообщения) с одним и тем же id несколько раз.                   |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             При этом:                                                                           |
|                       |         |              |         </p>                                                                                    |
...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <ul>                                                                                    |
|                       |         |              |             <li><code>true</code> — для сокращения ссылок (значение по умолчанию);</li>         |
...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Возможность пользоваться данным сервисом предварительно оговаривается и             |
|                       |         |              |             настраивается Сервис-Провайдером.                                                   |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Подробнее: см. <a href="https://doc.rapporto.ru/api/rest/rest_short_link.html">     |
...
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
| scheduleInfo/timeEnd  | нет     | string       | Время окончания.                                                                                |
|                       |         |              |                                                                                                 |
|                       |         |              | .. raw:: html                                                                                   |
|                       |         |              |                                                                                                 |
|                       |         |              |     <details>                                                                                   |
...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Если ограничений по дням недели нет, то данный параметр может быть пустой или       |   
...
|                       |         |              |         <summary>Подробнее</summary>                                                            |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Передается значение <code>SMS</code>.                                               |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+     
...
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
| message/data/         | да      | string       | Сервисное имя, от которого осуществляется отправка сообщения. Для передачи в запросе параметр   |
| serviceNumber         |         |              | является обязательным, если сервисное имя не указано в настройках клиента. Если указано, то в   |
|                       |         |              | запросе становится необязательным. Если указано в настройках клиента и передано в запросе,      |
|                       |         |              | то сообщение абоненту будет отправлено от имени, указанного в запросе.                          |                                                   
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+ 
...
|                       |         |              |         <summary>Подробнее</summary>                                                            |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Допустимый диапазон, мин: от 1 до 2880.                                             |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |     <div class="admonition note">                                                               |
|                       |         |              |         <p class="admonition-title">Примечание</p>                                              |
|                       |         |              |         <p>При <code>ttl = 0</code> или отсутствии параметра в запросе берётся                  |
|                       |         |              |            значение из настроек по умолчанию, которые задаются при настройке интеграции         |
|                       |         |              |            отдельно для каждого клиента.</p>                                                    |
|                       |         |              |     </div>                                                                                      |
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Допустимые значения: <code>SECONDS</code>; <code>MINUTES</code> (значение           |   
|                       |         |              |             по-умолчанию); <code>HOURS</code>.                                                  |
|                       |         |              |         </p>                                                                                    |
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
...
|                       |         |              |             <li><code>2</code> — нужен только статус <code>НЕ ДОСТАВЛЕНО</code>.</li>           |
|                       |         |              |         </ul>                                                                                   |
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Длина строки <code>notifyUrl</code> не должна превышать 2048 символов.              |   
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <p>                                                                                     |
...
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
| extraParam            | нет     | string       | Дополнительные параметры, передаваемые в виде ``param1=value1,param2=value2``, где ``param1``   |
|                       |         |              | и ``param2`` — названия параметров, ``value1`` и ``value2`` — значения.                         |
|                       |         |              |                                                                                                 |                              
|                       |         |              | .. raw:: html                                                                                   |
|                       |         |              |                                                                                                 |
|                       |         |              |     <details>                                                                                   |
...
Для ошибочных результатов HTTP-код ответа будет отличный от ``200 OK`` (см. :ref:`Коды-ошибок-отправки-SMS`).
