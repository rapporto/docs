...
.. tabs::
    ...
    .. tab:: Параметры отчета о доставке
        ...
        |             |         | | Параметр может передаваться, только если |
        |             |         |   для интеграции установлена опция         |
        |             |         |   "Передавать стоимость части в параметре  |
        |             |         |   segmentPrice (передается со статусом)“.  |
        |             |         |                                            |
        |             |         | Параметр может передаваться                |
        ...
        |             |         | | Параметр может передаваться, только если |
        |             |         |   для интеграции установлена опция         |
        |             |         |   "Передавать стоимость сообщения в        |
        |             |         |   параметре messagePrice                   |
        |             |         |   (передается со статусом)“.               |
        |             |         |                                            |
        |             |         | Параметр может передаваться                |
        |             |         | для следующих типов сообщений:             |
        |             |         |                                            |
