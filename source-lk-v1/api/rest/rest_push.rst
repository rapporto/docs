...
|                       |         |              |         </p>                                                                                    |
|                       |         |              |         <ul>                                                                                    |
|                       |         |              |             <li><code>true</code> — для сокращения ссылок                                       |           
|                       |         |              |             (значение по умолчанию);</li>                                                       |
|                       |         |              |             <li><code>false</code> — сокращение ссылки не требуется.</li>                       |
|                       |         |              |         </ul>                                                                                   |
|                       |         |              |         <p>                                                                                     |
...
|                       |         |              |         <p>                                                                                     |
|                       |         |              |             Подробнее: см. Сервис                                                               |
|                       |         |              |             <a href="https://doc.rapporto.ru/api/rest/rest_short_link.html">                    |
|                       |         |              |             Сервис сокращения ссылок</a>.                                                       |                               
|                       |         |              |         </p>                                                                                    |
|                       |         |              |     <div class="admonition note">                                                               |
|                       |         |              |         <p class="admonition-title">Примечание</p>                                              |
|                       |         |              |         <p>Возможность пользоваться данным сервисом предварительно оговаривается                |
|                       |         |              |            и настраивается Сервис-Провайдером.</p>                                              |
|                       |         |              |     </div>                                                                                      |  
|                       |         |              |     </details>                                                                                  |
+-----------------------+---------+--------------+-------------------------------------------------------------------------------------------------+
