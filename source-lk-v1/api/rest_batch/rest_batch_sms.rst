...
+---------------------------------+-------------------+-------------------------------------------------------------------------------------------------------------------------+
| messages/options                | object            | | Объект с данными, которые необходимы внешним системам при получении статусов сообщений.                               |
|                                 |                   | | Любой объект вида: {key1: value1,key2: value2}.                                                                       |
+---------------------------------+-------------------+-------------------------------------------------------------------------------------------------------------------------+
...
.. tabs::
    ...
    .. tab:: Параметры ответа
        ...
        +---------------------------------+-------------------+--------------------------------------------------------------------------------------------------------------------+
        | options                         | object            | | Дополнительные данные.                                                                                           |
        |                                 |                   | | Если были переданы в запросе на отправку,то будут возвращены в ответе в неизменном виде.                         |
        |                                 |                   | | Если переданы не были, то в ответе возвращены не будут.                                                          |
        +---------------------------------+-------------------+--------------------------------------------------------------------------------------------------------------------+
        | packetId                        | integer           | | Идентификатор пакета SMS-сообщений.                                                                              |
