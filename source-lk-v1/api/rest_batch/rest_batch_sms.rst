...
+---------------------------------+-------------------+-------------------------------------------------------------------------------------------------------------------------+
| messages/options                | object            | | Объект, который партнер отправляет в запросе на отправку сообщения и получает обратно в неизменном виде               |
|                                 |                   |   вместе со статусом.                                                                                                   |
|                                 |                   | | Данный объект не обрабатывается системой и предназначен для аналитики на стороне партнера.                            |
+---------------------------------+-------------------+-------------------------------------------------------------------------------------------------------------------------+
