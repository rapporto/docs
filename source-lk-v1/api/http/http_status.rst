...
.. important:: 1. Для SMS-сообщений, отправленных абонентам оператора Мегафон, с 01.03.2023 прекращена передача статусов ``2`` – доставлено и ``5`` – не доставлено.
    2. При отправке абоненту в мессенджер Telegram авторизационных кодов возможно получение только статусов ``2`` – доставлено и ``5`` – не доставлено. 
